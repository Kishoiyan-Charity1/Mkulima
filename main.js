class Mkulima {
    ...
    console.log(`${quantity} ${product.name} for ksh ${quantity*product.price}`);
    }

    let farmers=new Mkulima();
    farmers.addFarm("222","maize","Aley","072233744","616 Korongo");
    farmers.addFarm("99","peas","Ken","07274633","1002 Narok");
    farmers.addFarm("890","beans","Abu","07444483","663 Nairobi");
